...
STUDYNAME=with_errors_most_critical_only
JOBSFILE=with_errors_most_critical_only.jobs.yaml
...
AFSSUBMISSIONPATH=/afs/cern.ch/work/d/deveres/public/GRAP/hllhc-cliq-simulations/hl19/
