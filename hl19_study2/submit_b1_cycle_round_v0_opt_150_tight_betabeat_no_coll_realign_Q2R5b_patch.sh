...
STUDYNAME=b1_cycle_round_v0_opt_150_tight_betabeat_no_coll_realign_Q2R5b_patch
JOBSFILE=b1_cycle_round_v0_opt_150_tight_betabeat_no_coll_realign_Q2R5b_patch.jobs.yaml

ENVNAME=0.54.2
environments=()

# XSUITEPATH=''   # Install xsuite from PyPI
XSUITEPATH=/eos/home-d/deveres/GRAP/xsuite/
AFSSUBMISSIONPATH=/afs/cern.ch/work/d/deveres/public/GRAP/hllhc-cliq-simulations/hl19_study2/
...
then
    source ${STUDYPATH}/submission_scripts/environment.sh
else
    cd $SPOOLPATH
